...
src_java{"Hello"}, la continuation correspond aux deux lignes suivantes.
...
programmation fonctionnelle sont *les monades gratuites* et les 
...
possible d'utiliser "leur interface" au moyen, par exemple, de *Monades gratuites*,
