...
#+BEGIN_SRC javascript :data-roe-kind code :data-pellet Koka :data-line-number true
fun hello(name) {
  println("Hello " + name + "!")
}
#+END_SRC
...
#+BEGIN_SRC javascript :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 4
fun mumbling() : mumble () {
...
#+BEGIN_SRC javascript :data-roe-kind code :data-pellet Koka
...
#+BEGIN_SRC javascript :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 9
