...
Concrètement, les effets algébriques muni de gestionnaires proposent de découper
un programme en trois parties distinctes : 
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true
fun hello(name) {
  println("Hello " + name + "!")
}
#+END_SRC
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 4
fun mumbling() : mumble () {
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 9
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-hl 13 :data-line-start 10
val mumble_handler = handler {
  grumble(message) -> {
     println(message)
     resume(())
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 5
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 19
fun main() {
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 17
...
l'état final, auquel on concaténe la chaine src_ocaml{";end"}. Maintenant que
...
#+BEGIN_SRC kotlin :data-roe-kind code :data-pellet Koka :data-line-number true :data-line-start 22
fun test() {
