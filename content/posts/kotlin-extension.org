...
beaucoup moins utiles mais rigolos (enfin... je trouve) !
...
[[https://kotlinlang.org/api/latest/jvhttps://kotlinlang.org/docs/reference/extensions.m/stdlib/kotlin/with.html][with]]. Ce n'est probablement pas très utile, mais ça calme l'hystérie du
...
en utilisant la fonction [[https://kotlinlang.org/api/latest/jvhttps://kotlinlang.org/docs/reference/extensions.m/stdlib/kotlin/with.html][with]], il est possible d'appliquer une extension dans
